...
LED_Config_t led_RC1 = {.LED_pin = GPIO_PIN0,.LED_port = GPIO_PORTC,.LED_status = GPIO_HIGH};
LED_Config_t led_RC2 = {.LED_pin = GPIO_PIN0,.LED_port = GPIO_PORTC,.LED_status = GPIO_HIGH};
LED_Config_t led_RC3 = {.LED_pin = GPIO_PIN0,.LED_port = GPIO_PORTC,.LED_status = GPIO_HIGH};
