# 1 "MCAL_Layer/GPIO_Driver/Hal_GPIO.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/GPIO_Driver/Hal_GPIO.c" 2





# 1 "MCAL_Layer/GPIO_Driver/Hal_GPIO.h" 1
# 11 "MCAL_Layer/GPIO_Driver/Hal_GPIO.h"
# 1 "MCAL_Layer/GPIO_Driver/../STD_Libraries.h" 1
# 11 "MCAL_Layer/GPIO_Driver/../STD_Libraries.h"
...
# 11 "MCAL_Layer/GPIO_Driver/../STD_Libraries.h" 2
...
# 12 "MCAL_Layer/GPIO_Driver/../STD_Libraries.h" 2
...
# 13 "MCAL_Layer/GPIO_Driver/../STD_Libraries.h" 2
# 11 "MCAL_Layer/GPIO_Driver/Hal_GPIO.h" 2

# 1 "MCAL_Layer/GPIO_Driver/../STD_Types.h" 1
# 17 "MCAL_Layer/GPIO_Driver/../STD_Types.h"
...
# 12 "MCAL_Layer/GPIO_Driver/Hal_GPIO.h" 2
# 29 "MCAL_Layer/GPIO_Driver/Hal_GPIO.h"
...
# 6 "MCAL_Layer/GPIO_Driver/Hal_GPIO.c" 2
...
{
  STD_RETURN_TYPE ret = (STD_RETURN_TYPE)0X00 ;
  if((((void*)0) == Pin) || (((void*)0) == dir_status))
    {
      ret = (STD_RETURN_TYPE)0X00 ;
    }
  else
    {
      *dir_status = ((*tris_register[Pin->port] >> Pin->pin ) & 1);
      ret = (STD_RETURN_TYPE)0X01 ;
    }
  return ret;
}
...
{
  STD_RETURN_TYPE ret = (STD_RETURN_TYPE)0X00 ;
  if((((void*)0) == Pin) || (((void*)0) == logic_status))
    {
      ret = (STD_RETURN_TYPE)0X00 ;
    }
  else
    {
        *logic_status = ((*port_register[Pin->port] >> Pin->pin ) & 1);
        ret = (STD_RETURN_TYPE)0X01 ;
    }
  return ret;
}
...
STD_RETURN_TYPE gpio_pin_initialize(const Pin_Config *Pin)
{
  ...
  if(((void*)0) == Pin)
    ...
    {
      (*tris_register[Pin->port] &=~(1<<Pin->pin));
      (*port_register[Pin->port] &=~(1<<Pin->pin));
      ret = (STD_RETURN_TYPE)0X01 ;
    }
  return ret;
}
