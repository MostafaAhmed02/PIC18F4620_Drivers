...
# 106 "./MCAL_Layer/GPIO/HAL_GPIO.h"
...
uint8 tens = 0;
Segment_t Segment_1 = {
  .Seven_Pins[0].direction = GPIO_OUTPUT,
  .Seven_Pins[1].direction = GPIO_OUTPUT,
  .Seven_Pins[2].direction = GPIO_OUTPUT,
  .Seven_Pins[3].direction = GPIO_OUTPUT,

  .Seven_Pins[0].logic = GPIO_LOW,
  .Seven_Pins[1].logic = GPIO_LOW,
  .Seven_Pins[2].logic = GPIO_LOW,
  .Seven_Pins[3].logic = GPIO_LOW,

  .Seven_Pins[0].pin = GPIO_PIN0,
  .Seven_Pins[1].pin = GPIO_PIN1,
  .Seven_Pins[2].pin = GPIO_PIN2,
  .Seven_Pins[3].pin = GPIO_PIN3,

  .Seven_Pins[0].port = GPIO_PORTC,
  .Seven_Pins[1].port = GPIO_PORTC,
  .Seven_Pins[2].port = GPIO_PORTC,
  .Seven_Pins[3].port = GPIO_PORTC,
