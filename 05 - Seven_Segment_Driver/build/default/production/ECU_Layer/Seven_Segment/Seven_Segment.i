...
# 11 "ECU_Layer/Seven_Segment/Seven_Segment.h"
# 1 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/HAL_GPIO.h" 1
# 12 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/HAL_GPIO.h"
# 1 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/../STD_Types.h" 1
# 12 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/../STD_Types.h"
...
# 12 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/../STD_Types.h" 2
...
# 79 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/HAL_GPIO.h"
...
# 97 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/HAL_GPIO.h"
Std_ReturnType gpio_pin_read_direction (const Pin_Config_t *pin, Direction_t *dir);
# 106 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/HAL_GPIO.h"
Std_ReturnType gpio_pin_write_logic (const Pin_Config_t *pin, Logic_t logic);
# 115 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/HAL_GPIO.h"
...
# 21 "ECU_Layer/Seven_Segment/Seven_Segment.h"
typedef enum
{
...
# 8 "ECU_Layer/Seven_Segment/Seven_Segment.c" 2
...
seven_segment_initialize (const Segment_t *_7_seg)
{
  ...
  if (((void*)0) == _7_seg)
    ...
    {
      ret = gpio_pin_initialize (&(_7_seg->Seven_Pins[0]));
      ret = gpio_pin_initialize (&(_7_seg->Seven_Pins[1]));
      ret = gpio_pin_initialize (&(_7_seg->Seven_Pins[2]));
      ret = gpio_pin_initialize (&(_7_seg->Seven_Pins[3]));
...
{
  Std_ReturnType ret = (Std_ReturnType)0X00;
  if ((((void*)0) == _7_seg) && (number > 9))
    {
      ret = (Std_ReturnType)0X00;
    }
  else
    {
      ret = gpio_pin_write_logic (&(_7_seg->Seven_Pins[0]), number & 0x01);
      ret = gpio_pin_write_logic (&(_7_seg->Seven_Pins[1]), (number >> 1) & 0x01);
      ret = gpio_pin_write_logic (&(_7_seg->Seven_Pins[2]), (number >> 2) & 0x01);
      ret = gpio_pin_write_logic (&(_7_seg->Seven_Pins[3]), (number >> 3) & 0x01);
